...
int Ant::cost[] = { 10, 15, 20, 25, 30, 35, 40, 50 };		// koszt zakupu mrówki na poszczególnych poziomach
...
int main() {
	...
	textureBackground.loadFromFile("graphics/background2.jpg"); //Za³adowanie tekstury t³a
	...
	textureAnt[0].loadFromFile("graphics/ant_ani_1.png");
	textureAnt[1].loadFromFile("graphics/ant_ani_2.png");
	textureAnt[2].loadFromFile("graphics/ant_ani_3.png");
	textureAnt[3].loadFromFile("graphics/ant_ani_4.png");
	...
	std::vector<Lifebar*> antsLifebars;  //tablica paskow zdrowia

	std::vector<Ant*> opponents;	// tablica z wrogimi mrówkami
	std::vector<Lifebar*> opponentsLifebars;	//tablica z wrogimi paskami zdrowia
